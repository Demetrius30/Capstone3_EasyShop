...
// add the annotations to make this a REST controller--COMPLETE
@RestController
// add the annotation to make this controller the endpoint for the following url--COMPLETE
...
//     add the appropriate annotation for a get action
    ...
    // add the appropriate annotation for a get action--COMPLETE
